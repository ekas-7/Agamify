    ...
    return (
        <footer className="min-h-[500px] flex flex-col relative rounded-t-[40px] overflow-hidden bg-black">
            ...
            <div className="flex-1 flex flex-col justify-between relative z-10">
                <main className="max-w-[1400px] px-4 py-16 mx-auto w-full">
                    <div className="flex justify-between items-center h-full w-full">
                        <div className="flex flex-col gap-2">
                            <a
                                href="#pricing"
                                className="text-white/80 hover:text-white transition-colors font-fustat text-base font-light"
                            >
                                PRICING
                            </a>
                            <a
                        ...
                        <div className="flex flex-col justify-between h-full items-center gap-4">
                            ...
                            <div className="opacity-0 text-[5px]">asasd</div>
                            <a
                                href="#terms"
                                className="text-white/80 hover:text-white transition-colors font-fustat text-base"
                            >
